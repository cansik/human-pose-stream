...
static const char target_input_index_message[] = "Optional. Input device index to open.";
...
/// @brief Defines parameter for the target device index <br>
/// It is an optional parameter
DEFINE_string(index, "0", target_input_index_message);
...
static void showUsage() {
    ...
    std::cout << "    -index [id]                " << target_input_index_message << std::endl;
